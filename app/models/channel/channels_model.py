...
class Channel(Base):
    ...
    __table_args__ = (UniqueConstraint("name", "creator_id", name="uq_channel_name_creator"),)

    # Relationships with fully qualified string references
    creator: Mapped[User] = relationship("app.models.user_models.User", back_populates="channels")
